...
For basic installation and initial configuration, see [Installation](../../installation.md). For detailed information about the Configuration System architecture, see [Configuration](../../configuration/index.md). For deployment strategies, see [Docker Deployment](docker.md).
