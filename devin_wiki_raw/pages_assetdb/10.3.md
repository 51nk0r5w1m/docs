...
For information about how these types are used in the Repository interface operations, see [Repository Interface](#10.1). For details on Open Asset Model integration and asset/property/relation definitions, see [Open Asset Model Integration](#3.3).
...
**Sources:** [types/types.go:13-47](), [migrations/postgres/001_schema_init.sql:5-9](), [migrations/sqlite3/001_schema_init.sql:8-9]()
...
**Sources:** [types/types.go:7-47](), [migrations/postgres/001_schema_init.sql:7-8](), [migrations/sqlite3/001_schema_init.sql:10-11]()
...
**Sources:** [types/types.go:13-47](), [migrations/postgres/001_schema_init.sql:1-90](), [migrations/sqlite3/001_schema_init.sql:1-85]()