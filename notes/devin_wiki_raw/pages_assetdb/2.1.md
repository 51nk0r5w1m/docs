...
**Sources:** [go.mod:1-48](), Diagram 4 from high-level architecture
...
**Sources:** [go.mod:5-16](), [go.sum:1-129]()
...
**Sources:** [go.mod:7](), [go.mod:22](), [go.mod:47](), [go.sum:10-13](), [go.sum:124-125]()
...
**Sources:** [go.mod:14](), [go.mod:27-28](), [go.sum:27-34](), [go.sum:97-98]()
...
**Sources:** [go.mod:1-48](), [go.sum:1-129]()
...
1. **Configure Database Connection:** See [Database Configuration](#2.2) for details on connecting to PostgreSQL, SQLite, or Neo4j
...
4. **Basic Operations:** Try creating entities and edges with [Basic Usage Examples](#2.3)
