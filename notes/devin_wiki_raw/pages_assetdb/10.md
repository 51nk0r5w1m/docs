...
- **[Repository Interface](#10.1)** - Complete method signatures and behavior
- **[Cache Interface](#10.2)** - Caching layer methods and configuration
- **[Core Data Types](#10.3)** - Entity, Edge, EntityTag, and EdgeTag structures

For architectural context about how these APIs fit into the system design, see [Architecture](#3).
...
**Sources:** [repository/repository.go:22-44]()
