...
- [repository/neo4j/edge.go](repository/neo4j/edge.go)
- [repository/neo4j/edge_test.go](repository/neo4j/edge_test.go)
...
**Sources:** [repository/neo4j/edge.go:1-341]()
...
**Sources:** [repository/neo4j/edge.go:20-86](), [types/types.go]()
...
**Sources:** [repository/neo4j/edge.go:20-86]()
...
**Sources:** [repository/neo4j/edge.go:24-27]()
...
**Sources:** [repository/neo4j/edge.go:29-33]()
...
**Sources:** [repository/neo4j/edge.go:55-65]()
...
**Sources:** [repository/neo4j/edge.go:88-110]()
...
**Sources:** [repository/neo4j/edge.go:113-126]()
...
**Sources:** [repository/neo4j/edge.go:128-179]()
...
**Sources:** [repository/neo4j/edge.go:181-250]()
...
**Sources:** [repository/neo4j/edge.go:252-321]()
...
**Sources:** [repository/neo4j/edge.go:181-321]()
...
**Sources:** [repository/neo4j/edge.go:323-340]()
...
**Sources:** [repository/neo4j/edge.go:70-85](), [repository/neo4j/edge.go:148-178]()
...
|------|-------------|----------------|
| `TestCreateEdge` | Tests edge creation, validation, and duplicate handling | [repository/neo4j/edge_test.go:19-59]() |
| `TestFindEdgeById` | Tests edge retrieval by ID | [repository/neo4j/edge_test.go:61-91]() |
| `TestIncomingEdges` | Tests incoming edge traversal and filtering | [repository/neo4j/edge_test.go:93-143]() |
| `TestOutgoingEdges` | Tests outgoing edge traversal and filtering | [repository/neo4j/edge_test.go:145-195]() |
| `TestDeleteEdge` | Tests edge deletion | [repository/neo4j/edge_test.go:197-224]() |
...
**Sources:** [repository/neo4j/edge_test.go:1-225]()
...
**Sources:** [migrations/neo4j/schema.go:67-70]()
