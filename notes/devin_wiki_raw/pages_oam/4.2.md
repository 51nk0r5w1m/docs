...
**Sources:** [relation.go:19-25](), [dns/dns_record.go:19-84]()
...
**Sources:** [dns/dns_record.go:13-17]()
...
**Sources:** [dns/dns_record_test.go:32-36]()
...
**Sources:** [dns/dns_record.go:19-23]()
...
**Sources:** [dns/dns_record.go:25-38]()
...
**Sources:** [dns/dns_record_test.go:46-60]()

### Usage in Taxonomy

The relationship taxonomy in [relation.go:76-85]() defines that FQDN assets can use `BasicDNSRelation` with the `"dns_record"` label to connect to:
...
**Sources:** [relation.go:76-85](), [relation.go:100-103]()
...
**Sources:** [dns/dns_record.go:40-45]()
...
**Sources:** [dns/dns_record.go:47-60]()
...
**Sources:** [dns/dns_record_test.go:97-112]()
...
**Sources:** [dns/dns_record.go:62-69]()
...
**Sources:** [dns/dns_record.go:71-84]()
...
**Sources:** [dns/dns_record_test.go:153-170]()
...
**Sources:** [relation.go:281-295](), [relation.go:205-226]()
...
**Sources:** [dns/dns_record_test.go:29-44]()
...
**Sources:** [dns/dns_record_test.go:78-95]()
...
**Sources:** [dns/dns_record_test.go:130-151]()
...
**Sources:** [dns/dns_record_test.go:24-26](), [dns/dns_record_test.go:73-75](), [dns/dns_record_test.go:125-127]()