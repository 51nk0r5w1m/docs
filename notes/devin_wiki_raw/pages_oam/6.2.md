...
**Sources:** [asset.go:7-11](), [account/account_test.go](), [platform/service_test.go](), [file/file_test.go]()
...
**Sources:** [account/account_test.go:29-30](), [platform/service_test.go:26-27](), [org/org_test.go:27-28](), [file/file_test.go:24-25]()
...
**Account Key Test** [account/account_test.go:14-26]():
```go
...
**Service Key Test** [platform/service_test.go:13-23]():
```go
...
**Sources:** [account/account_test.go:14-26](), [platform/service_test.go:13-23](), [org/org_test.go:14-24](), [file/file_test.go:14-21]()

---

### AssetType() Method Testing

The `AssetType()` method must return the correct `AssetType` constant as defined in [asset.go:15-37](). This test validates type classification correctness.

#### Standard AssetType Test Pattern

All AssetType tests follow this structure [account/account_test.go:28-39]():
...
|------------|-------------------|---------------------|
| Account | `model.Account` | [account/account_test.go:28-39]() |
| Service | `model.Service` | [platform/service_test.go:25-35]() |
| Organization | `model.Organization` | [org/org_test.go:26-37]() |
| File | `model.File` | [file/file_test.go:23-34]() |
| FundsTransfer | `model.FundsTransfer` | [financial/funds_transfer_test.go:23-34]() |

**Sources:** [asset.go:13-37](), [account/account_test.go:28-39](), [platform/service_test.go:25-35](), [org/org_test.go:26-37]()
...
The expected JSON string must match the struct's JSON tags exactly. Compare struct definition [account/account.go:18-25]() with expected output:
...
Service assets have nested structures requiring careful validation [platform/service_test.go:37-60]():
...
**Sources:** [account/account.go:18-25](), [account/account_test.go:41-60](), [platform/service.go:19-25](), [platform/service_test.go:37-60](), [org/org_test.go:39-60]()
...
**Sources:** [account/account_test.go](), [platform/service_test.go](), [org/org_test.go](), [file/file_test.go]()
...
|-----------|----------------------|---------|
| Key() test | `Type.Key() = %v, want %v` | [account/account_test.go:24]() |
| AssetType() test | `Expected asset type %v but got %v` | [account/account_test.go:38]() |
| JSON() error check | `Unexpected error: %v` | [account/account_test.go:54]() |
| JSON() comparison | `Expected JSON %v but got %v` | [account/account_test.go:58]() |
...
**Sources:** [account/account_test.go](), [platform/service_test.go](), [org/org_test.go]()
...
- [ ] AssetType test verifies correct constant from [asset.go:15-37]()
...
**Sources:** All test files referenced throughout this document